...
test('auction player inspector shows history and supports close and draft actions', async ({ page }) => {
  ...
  await expect(inspector.locator('thead')).toContainText('Paid')
  await expect(inspector.locator('thead')).toContainText('Diff')
  await expect(inspector.locator('tfoot')).toContainText('Average')
