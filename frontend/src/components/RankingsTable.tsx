      ...
      <table className={`rankings-table ${isEspn ? 'rankings-table--espn' : 'rankings-table--fpros'}${stickyHeaders ? ' rankings-table--sticky-headers' : ''}`}>
        ...
        <thead>
          <tr>
            ...
            {isEspn ? <th className="num-heading price-heading"><span>Value</span></th> : null}
            ...
            <th className="num-heading diff-heading"><SortButton label="Delta" ariaLabel={isEspn ? 'Sort by value delta' : 'Sort by ranking delta'} sortKey="diff" activeKey={sortKey} direction={sortDirection} onSort={onSort} /></th>
