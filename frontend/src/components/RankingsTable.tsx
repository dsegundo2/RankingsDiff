          ...
          {rows.map((row, index) => {
            ...
            return (
              ...
              >
                ...
                {showYahooProjections ? <td className="num yahoo-projection-cell"><span className="stacked-price"><strong>{seasonProjection > 0 ? seasonProjection.toFixed(0) : '—'}</strong><small>{seasonProjection > 0 ? `(${week1Projection > 0 ? `${week1Projection.toFixed(1)} wk 1` : 'No week 1 data'})` : 'No data'}</small></span></td> : null}
