...
const heroOptions: Array<{ id: HeroStyle; name: string; description: string }> = [
  ...
  { id: 'quiet', name: 'No hero image', description: 'Removes the image and lets the Draft Distillery identity lead.' }
]
...
export function HeroRecentMockups() {
  ...
  return <main className="hero-recent-mock-page">
    <div className="hero-recent-mock-page__topbar"><a href="./">← Back to dashboard</a><span>Draft Distillery · hero and recent actions study</span><b>HTML mockups</b></div>
